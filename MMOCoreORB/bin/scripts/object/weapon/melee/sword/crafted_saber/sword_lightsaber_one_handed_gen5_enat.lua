...
object_weapon_melee_sword_crafted_saber_sword_lightsaber_one_handed_gen5 = object_weapon_melee_sword_crafted_saber_shared_sword_lightsaber_one_handed_gen5:new {
	...
	-- Leave blank for now
	damageModifiers = { jedi_force_power_max=200000, jedi_force_power_regen=1000, onehandlightsaber_accuracy=3000, onehandlightsaber_speed=100, saber_block=100, onehandlightsaber_toughness=100000  },
